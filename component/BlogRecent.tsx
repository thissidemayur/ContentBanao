            ...
            <div className="mx-auto max-w-screen-xl px-4 md:px-8">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-gray-500 text-lg">
                        Fresh insights, curated ideas, and practical guides to keep you informed and ahead.
                    </p>
                </div>

                {/* Loading / 2Error */}
                {loading && <p className="text-center text-gray-500 mt-8">Loading posts...</p>}
                ...
                {!loading && !error && (
                    <div className="grid gap-10 sm:grid-cols-2 xl:grid-cols-2">
                        {posts?.map((post) => (
                            ...
                            >
                                <Link href={`/blog/${encodeURIComponent(post.slug)}`} className="relative h-64 w-full">
                                    <Image
                                        src={post?.media[0]?.url || "/images/fallback.png"}
